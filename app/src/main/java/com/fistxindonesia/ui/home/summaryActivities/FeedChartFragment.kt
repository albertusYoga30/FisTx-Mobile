...
class FeedChartFragment : Fragment() {
    ...
    private var _binding: FragmentFeedChartBinding? = null
    ...
    private fun initChart() {
        ...
        listData1.add(Entry(1f, 4f))
        listData1.add(Entry(2f, 2f))
        listData1.add(Entry(3f, 3f))
        listData1.add(Entry(4f, 1f))
        listData1.add(Entry(5f, 4f))

        val listData2 = ArrayList<Entry>()
        listData2.add(Entry(0f, 3f))
        listData2.add(Entry(1f, 3f))
        listData2.add(Entry(2f, 4f))
        listData2.add(Entry(3f, 4f))
        listData2.add(Entry(4f, 4f))
        listData2.add(Entry(5f, 5f))
        ...
        lineData2.color = ContextCompat.getColor(requireContext(), R.color.secondary_fade1)
